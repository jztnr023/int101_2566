...
public class Int101Homework01 {
    ...
    static void work03UseOfUtilityClass() {
        System.out.println(MyUtil.calculateBMI(75, 1.8));
        System.out.println(MyUtil.average(18, 25, 22));
    ...
    static void work04UseOfObjectClass() {
        Person Thanarat = new Person(20042547);
        System.out.println(Thanarat);
        Person Hill = new Person(123456);
        System.out.println(Hill);
        BankAccount SCB = new BankAccount(256555, Hill);
