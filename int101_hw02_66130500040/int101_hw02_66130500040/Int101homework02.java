...
public class Int101homework02 {
    ...
    static void work01Utilitor() {
        ...
        System.out.println(Utilitor.testString("Jul"));
    ...
    static void work02Person() {
        Person p1 = new Person("Thanarat", "Pudpoh");
        Person p2 = new Person("Jul", "Jija");
        Person p3 = new Person("Jill", "Yudhom");
        ...
        p2.setFirstname("Hill");
        p2.setLastname("Jomyud");
